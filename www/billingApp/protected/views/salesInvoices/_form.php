...
<div class="form" style="border: 1px inset #e1e1e1;padding: 2% ">
    ...
    <div id="form-content" style="margin-right: 5%;">
        ...
        if($mode==='update')
        {
            ...
            {
                $this->renderPartial('_form-sales-info',array('form'=>$form,'model2'=>$indmodel,'sts'=>$sts,'errors'=>$errors));
                $sts++;
            }
            $sts--;
        }
        ...
        {
            $this->renderPartial('_form-sales-info',array('form'=>$form,'model2'=>$model2,'sts'=>0,'errors'=>$errors));
        }
    ...
    <div class="row buttons">
        <?php echo CHtml::submitButton(
            ...
            array(
                'class'=>'btn btn-success sales-invoices-form-submit'
            )
        ); ?>
