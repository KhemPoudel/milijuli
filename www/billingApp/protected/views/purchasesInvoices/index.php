<?php if(Yii::app()->user->hasFlash('purchase_invoice_deletion')):?>
    <div class="alert alert-warning alert-dismissible info" role="alert">
        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <strong>Yeah</strong> <?php echo Yii::app()->user->getFlash('purchase_invoice_deletion');?>
    </div>
<?php endif; ?>
<table class="table table-striped table-bordered">
    ...
    <?php foreach($models as $model): ?>
        <tr>
            ...
            <td>
                <?php
                echo CHtml::link($model->balance-$model->credited,$this->createAbsoluteUrl('purchasesInvoices/viewTransaction',array('id'=>$model->id)));
                ?>
            </td>
            <td>
                <?php
