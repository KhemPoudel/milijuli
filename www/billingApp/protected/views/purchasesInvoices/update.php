<h1>Update PurchasesInvoices <?php echo $model1->id; ?></h1>
...
<?php endif; ?>
<?php $this->renderPartial('_form', array('model1'=>$model1,'model2'=>$model2,'paidModel'=>$paidModel,'errors'=>$errors,'mode'=>'update')); ?>
<?php
