<?php if(Yii::app()->user->hasFlash('supplier_deletion')):?>
    <div class="alert alert-warning alert-dismissible info" role="alert">
        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <strong>Yeah</strong> <?php echo Yii::app()->user->getFlash('supplier_deletion');?>
    </div>
<?php endif; ?>
<?php if(Yii::app()->user->hasFlash('supplier_addition')):?>
    <div class="alert alert-success alert-dismissible info" role="alert">
        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <strong>Yeah</strong> <?php echo Yii::app()->user->getFlash('supplier_addition');?>
    </div>
<?php endif; ?>
<?php if(Yii::app()->user->hasFlash('supplier_update')):?>
    <div class="alert alert-success alert-dismissible info" role="alert">
        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <strong>Yeah</strong> <?php echo Yii::app()->user->getFlash('supplier_update');?>
    </div>
<?php endif; ?>
<?php
